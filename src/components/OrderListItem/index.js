...
const OrderListItem = ({ order, refetch }) => {
  ...
  const { id, status, totalPrice, productsRequested, date } = updatedOrder;
  ...
  <span className="font-weight-normal"> {id}</span>
          ...
          <p className="card-text font-weight-bold">Date Issued:
  <span className="font-weight-normal"> {displayData}</span>
          </p>
          <p className="card-text font-weight-bold">Total:
  <span className="font-weight-normal"> ${totalPrice}</span>
          </p>
